...
function testService() {
    return __awaiter(this, void 0, void 0, function () {
        var healthResponse, testRequest, extractionResponse, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.get('http://localhost:3000/api/health')];
                case 1:
                    ...
                    return [4 /*yield*/, axios_1.default.post('http://localhost:3000/api/extract', testRequest)];
                case 2:
                ...
                case 3:
                    ...
                    if (axios_1.default.isAxiosError(error_1)) {
                        console.error('Test failed:', ((_a = error_1.response) === null || _a === void 0 ? void 0 : _a.data) || error_1.message);
                    }
                    else {
